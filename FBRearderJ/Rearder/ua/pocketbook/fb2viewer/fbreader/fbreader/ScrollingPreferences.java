...
public class ScrollingPreferences {
	...
	public final ZLBooleanOption FlickOption = new ZLBooleanOption("Scrolling", "Flick", false);
	public final ZLBooleanOption VolumeKeysOption = new ZLBooleanOption("Scrolling", "VolumeKeys", true);
	public final ZLBooleanOption AnimateOption = new ZLBooleanOption("Scrolling", "ShowAnimated", false);
