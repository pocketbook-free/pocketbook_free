...
import ua.pocketbook.fb2viewer.zlibrary.text.model.ZLTextMark;
...
//	private int myModelIndex;
	...
	/*public void setCursor(ZLTextModel model,String cursor) {
		try{
		//	Log.i("setCursor", "  "+cursor);
		//	Log.i("setCursor", "  "+model);
			...
			myElementIndex = Integer.parseInt(cursor.substring(0, cursor.indexOf(',')));
			
			cursor = cursor.substring(cursor.indexOf(',')+1);
			myCharIndex = Integer.parseInt(cursor);		
				
		
		}catch(Exception e){
			
			Log.i("setCursor", e.toString());
		}
	}*/
	...
	public String toString() {
		...
		return ""+myParagraphCursor.Index + "," + myElementIndex + "," + myCharIndex ;
	}
}
