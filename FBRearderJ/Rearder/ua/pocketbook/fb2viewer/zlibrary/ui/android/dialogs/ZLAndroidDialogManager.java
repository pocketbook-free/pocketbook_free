...
package ua.pocketbook.fb2viewer.zlibrary.ui.android.dialogs;
...
import ua.pocketbook.fb2viewer.zlibrary.core.dialogs.*;
import ua.pocketbook.fb2viewer.zlibrary.core.resources.ZLResource;
import ua.pocketbook.fb2viewer.zlibrary.ui.android.*;
	...
	*/
	...
	public void wait(String key, Runnable action, Activity activity) {
		...
		synchronized (this) {
			...
			if(key.equals("loadingBook")){
				message = ReaderActivity.instance.getResources().getString(R.string.wait_loading_page) ;
				
			}else{
				message = "";// getWaitMessageText(key);
			}
