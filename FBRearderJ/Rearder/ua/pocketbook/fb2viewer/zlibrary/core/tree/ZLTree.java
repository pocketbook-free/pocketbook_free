...
package ua.pocketbook.fb2viewer.zlibrary.core.tree;
...
public abstract class ZLTree<T extends ZLTree> implements Iterable<T> {
	...
	public ZLTree(int nullLevel, T parent, int position) {
	...
	public int getPosition(){
		...
		int i=0;
		for(Object t: Parent.mySubTrees){
			i++;
			if(this == t) return i;
		}
		return 0;
