...
public:
	...
	static std::string EncodingOverride;
	static std::string LanguageOverride;
        static bool calc_in_progress;        
public:
	enum ViewMode {
		UNDEFINED_MODE = 0,
		BOOK_TEXT_MODE = 1 << 0,
...
public:
	...
	bool isBookReady();
	bool getGlobalAllowHyphenations();
	void setGlobalAllowHyphenations(bool value);
...
private:
	...
	bool myBookReady; // PB: is this book is successfully opened
	bool myGlobalAllowHyphenations; // PB: device settings
