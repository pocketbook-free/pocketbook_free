...
GBool PreScanOutputDev::beginType3Char(GfxState * /*state*/, FixedPoint /*x*/, FixedPoint /*y*/,
...
void PreScanOutputDev::beginTransparencyGroup(
			   GfxState * /*state*/, FixedPoint * /*bbox*/,
...
void PreScanOutputDev::check(GfxColorSpace *colorSpace, GfxColor *color,
			     FixedPoint opacity, GfxBlendMode blendMode) {
  GfxRGB rgb;
