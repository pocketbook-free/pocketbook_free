...
private:
  ...
  FixedPoint baseMatrix[6];		// default matrix for most recent
				//   page/form/pattern
  int formDepth;
  ...
  void gouraudFillTriangle(FixedPoint x0, FixedPoint y0, GfxColor *color0,
  ...
  void doForm1(Object *str, Dict *resDict, FixedPoint *matrix, FixedPoint *bbox,
