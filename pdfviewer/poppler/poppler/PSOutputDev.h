...
public:
  ...
  //----- miscellaneous
  void setOffset(FixedPoint x, FixedPoint y)
    { tx0 = x; ty0 = y; }
  void setScale(FixedPoint x, FixedPoint y)
    { xScale0 = x; yScale0 = y; }
  void setRotate(int rotateA)
    { rotate0 = rotateA; }
  void setClip(FixedPoint llx, FixedPoint lly, FixedPoint urx, FixedPoint ury)
...
private:
  ...
  void addProcessColor(FixedPoint c, FixedPoint m, FixedPoint y, FixedPoint k);
  ...
  void opiTransform(GfxState *state, FixedPoint x0, FixedPoint y0,
  ...
  FixedPoint tx0, ty0;		// global translation
  FixedPoint xScale0, yScale0;	// global scaling
  int rotate0;			// rotation angle (0, 90, 180, 270)
  FixedPoint clipLLX0, clipLLY0,
         clipURX0, clipURY0;
  FixedPoint tx, ty;		// global translation for current page
  FixedPoint xScale, yScale;	// global scaling for current page
  int rotate;			// rotation angle for current page
  FixedPoint epsX1, epsY1,		// EPS bounding box (unrotated)
         epsX2, epsY2;
  ...
  FixedPoint t3WX, t3WY,		// Type 3 character parameters
