...
SplashXPath::SplashXPath(SplashPath *path, SplashCoord *matrix,
  ...
  static SplashCoord V001 = (SplashCoord)0.01;
  ...
  if (path->hints) {
	...
	ww = 1;
      ...
      adjusts[i].x0a = adj0 - V001;
      adjusts[i].x0b = adj0 + V001;
      adjusts[i].xma = V05 * (adj0 + adj1) - V001;
      adjusts[i].xmb = V05 * (adj0 + adj1) + V001;
      adjusts[i].x1a = adj1 - V001;
      adjusts[i].x1b = adj1 + V001;
      adjusts[i].x0 = splashRound(adj0);
      adjusts[i].x1 = adjusts[i].x0 + ww - V001;
      adjusts[i].xm = V05 * (adjusts[i].x0 + adjusts[i].x1);
