...
extern struct platform_device s3c_device_gpio_keys;//add by Lucifer
...
extern struct platform_device platform_led1;   //William add
extern struct platform_device platform_led2;
