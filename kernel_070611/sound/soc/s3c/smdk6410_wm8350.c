	...
	struct snd_pcm_hw_params *params)
{
	 ...
	 * both the wm8350 codec as well as the S5P6410 AP
	 *
	 * wm8350 codec supports only S16_LE, S18_3LE, S20_3LE & S24_LE.
...
static int smdk6410_wm8350_init(struct snd_soc_codec *codec)
{
	int i;

	/* Add smdk6410 specific widgets */
	snd_soc_dapm_new_controls(codec, wm8350_dapm_widgets,ARRAY_SIZE(wm8350_dapm_widgets));
	...
	for (i = 0; i < ARRAY_SIZE(wm8350_dapm_widgets); i++)
		snd_soc_dapm_enable_pin(codec, wm8350_dapm_widgets[i].name);
...
/*
static struct wm8350_setup_data smdk6410_wm8350_setup = {
	.i2c_address = 0x1A,
};
*/
static struct snd_soc_device smdk6410_snd_devdata = {
	...
	//.codec_data = &smdk6410_wm8350_setup,
};
...
/* Module information */
MODULE_DESCRIPTION("ALSA SoC SMDK6410 wm8350");
MODULE_LICENSE("GPL");
