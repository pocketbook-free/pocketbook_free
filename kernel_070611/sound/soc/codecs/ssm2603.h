/*
 * File:         sound/soc/codecs/ssm2603.h
...
/* SSM2603 Codec Register definitions */

#define SSM2603_LINVOL   0x00
#define SSM2603_RINVOL   0x01
#define SSM2603_LOUT1V   0x02
#define SSM2603_ROUT1V   0x03
#define SSM2603_APANA    0x04
#define SSM2603_APDIGI   0x05
#define SSM2603_PWR      0x06
#define SSM2603_IFACE    0x07
#define SSM2603_SRATE    0x08
#define SSM2603_ACTIVE   0x09
#define SSM2603_RESET	 0x0f
...
#define SSM2603_CACHEREGNUM 	10

#define SSM2603_SYSCLK	0
#define SSM2603_DAI		0

struct ssm2603_setup_data {
	int i2c_bus;
	unsigned short i2c_address;
};

extern struct snd_soc_dai ssm2603_dai;
extern struct snd_soc_codec_device soc_codec_dev_ssm2603;

#define SND_RAMP_UP    0x0
#define SND_RAMP_DOWN  0x1
#define SND_SPK_MUTE   0x1
#define SND_SPK_UMUTE  0x0

struct SND_Headphone {
	struct delayed_work delayed_work;
	u8  ramp;
};

extern struct SND_Headphone *psnd_hp;
#endif
