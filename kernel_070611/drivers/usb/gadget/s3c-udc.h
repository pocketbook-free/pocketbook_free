...
enum  udc_cable_statusENUM{
	STATUS_UDC_NOT_INSTALL,
	STATUS_UDC_CONNECT,
	STATUS_UDC_GET_SUPPLIES,
	STATUS_UDC_GADGET_DRIVER_INSTALL,
	STATUS_UDC_SET_POWER_DOWN_BIT,
	STATUS_UDC_CLEAR_POWER_DOWN_BIT,
	STATUS_UDC_RESET,
	STATUS_UDC_UNINSTALL,
};
enum USB_MODE{
	USB_UNDEFINED,
	PC_LINK,
