...
struct adxl345_platform_data {
	 ...
	 * form with a scale factor of 15.6 mg/LSB (i.e. 0x7F = +2 g)    P14
	 */
...
//William add for polling and interrupt detect
	...
	#define POLLING_G_SENSOR		1
#endif

#undef POLLING_G_SENSOR
