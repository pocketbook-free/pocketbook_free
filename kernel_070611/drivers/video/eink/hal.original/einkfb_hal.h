...
#ifdef CONFIG_ARCH_FIONA    //------------- (Linux 2.6.10) Build
...
//#define EINKFB_DEBUG_FULL       (einkfb_logging_crit | einkfb_logging_error | einkfb_logging_info |	einkfb_logging_debug_full | einkfb_logging_debug_lock |	einkfb_logging_debug_power | einkfb_logging_debug_ioctl | einkfb_logging_debug_poll)
...
enum einkfb_logging_level
{
    ...
    einkfb_logging_default      = _LLOG_LEVEL_DEFAULT,	// LLOG_LEVEL_MASK_ALL ,  
...
#define EINKFB_16BPP            EINK_16BPP
...
struct einkfb_hal_ops_t
{
    ...
    bool (*hal_pan_display)(struct fb_var_screeninfo *var, struct fb_info *info);//jimmy+++
    ...
    void (*hal_ex3_update_area)(char *buffer,fx_type update_mode, u16 bdrupd, u16 xstart,u16 ystart,u16 xwidth,u16 yheight);
    
// EPD update function.   
    bool (*hal_x3_update_display_all)(fx_type update_mode, struct fb_info *info);
    bool (*hal_x3_update_display_area)(update_area_t *update_area, struct fb_info *info);
    bool (*hal_x3_update_display_area_du)(update_area_t *update_area, struct fb_info *info);
    bool (*hal_x3_epd_hangwrite_flag)(update_area_u16 *update_area, struct fb_info *info);
    bool (*hal_ep3_update_display_image)(update_area_t *update_area, struct fb_info *info);
    bool (*hal_show_display_image)(int update_mode);
    bool (*hal_show_display_area_image)(int update_mode);
    bool (*hal_epd_fill_pixel) (int pixel_mode);
	
// EPD update function.   

    bool (*hal_do_bs_mode_switch) (int bs_mode);
    bool (*hal_do_normal_inverted_switch) (int picture_mode);
    int (*hal_bs_read_temperature) (void);
    int (*hal_bs_readfromflash) (unsigned long addr, unsigned char *data);
    int (*hal_bs_writetoflash) (unsigned long start_addr, unsigned char *buffer, unsigned long blen);
    void (*hal_bs_pen_calibrate) (u16 HSize, u16 VSize, u16 xyswap);
    void (*hal_bs_penwrite_mode)(bool mode, unsigned char drawdata[10] );	
};
...
extern void einkfb_set_bpp(unsigned long bpp);
