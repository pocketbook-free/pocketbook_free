...
VERSION = 4.4.1
UNICODE_VERSION = 5.2
SO_TARGET_VERSION = 44.1
SO_TARGET_VERSION_MAJOR = 44
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt44
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt44 
ICUDATA_CHAR = l
...
CFLAGS =  -O3 -Wall -ansi -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings -Wno-long-long $(THREADSCFLAGS)
# CXXFLAGS is for C++ only flags
CXXFLAGS =  -O3 -W -Wall -ansi -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long $(THREADSCXXFLAGS)
