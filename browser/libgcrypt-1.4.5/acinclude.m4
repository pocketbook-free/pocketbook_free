...
#  fi
  if test $ok = yes; then
    GPG_ERROR_CFLAGS="-I~/projects/FRSCSDK/arm-none-linux-gnueabi/sysroot/usr/include"
    GPG_ERROR_LIBS="-L~/projects/FRSCSDK/arm-none-linux-gnueabi/sysroot/usr/lib -lgpg-error"
    AC_MSG_RESULT(yes)
    ifelse([$2], , :, [$2])
  else
    GPG_ERROR_CFLAGS=""
