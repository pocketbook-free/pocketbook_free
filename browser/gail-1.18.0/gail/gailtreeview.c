                          ...
                          gint      i)
{
  ...
  /* XXX FIXME: The code below avoids SEGV but it also avoids the issue;
   * probably we should be returning minimally-functional AtkObject instances
   * instead.  See bugzilla.gnome.org #331042.
   */
