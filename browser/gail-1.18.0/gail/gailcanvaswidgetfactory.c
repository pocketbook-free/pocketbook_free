...
GType
gail_canvas_widget_factory_get_type (void)
{
  static GType type = 0;
  ...
  if (!type) 
  {
    ...
    {
      sizeof (GailCanvasWidgetFactoryClass),
      (GBaseInitFunc) NULL, /* base init */
      (GBaseFinalizeFunc) NULL, /* base finalize */
      (GClassInitFunc) gail_canvas_widget_factory_class_init, /* class init */
      (GClassFinalizeFunc) NULL, /* class finalize */
      NULL, /* class data */
      sizeof (GailCanvasWidgetFactory), /* instance size */
      0, /* nb preallocs */
    ...
    type = g_type_register_static (
                           ...
                           "GailCanvasWidgetFactory" , &tinfo, 0);
  }
