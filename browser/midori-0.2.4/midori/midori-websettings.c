...
midori_web_settings_class_init (MidoriWebSettingsClass* class)
{
    ...
    */
    ...
    g_object_class_install_property (gobject_class,
                                     ...
                                     "QuickMenu,Back,Forward,ReloadStop,Location,Tabs", /*Modified by SBielov: "TabNew,Back,Forward,Next,ReloadStop,Location,Panel,Search,Trash",*/
                                     flags));
...
*/
	char *user_agent = GetUserAgent();
	return user_agent ? user_agent : g_strdup("Mozilla/5.0 (compatible; MSIE 8.0; Windows CE; PPC; 600x800)");
}
                                  ...
                                  GParamSpec*   pspec)
{
    ...
    case PROP_PREFERRED_LANGUAGES:
        katze_assign (web_settings->http_accept_language, g_strdup(ReadString(GetGlobalConfig(), "language", "en")));
        break;
